    ...
    return (
        <div className={"bg-[#FFF8F1] mt-[40px] rounded-[20px] md:grid md:grid-cols-2 md:justify-between xs:flex xs:flex-col xs:justify-center xs:items-center xs:text-center"}>
            ...
            <div className="flex flex-col sm:text-center md:text-left text-[#4A362A] sm:pl-0 md:pl-[20px] xl:pl-[56px] pt-[20px] pb-[88px]">
                ...
                <button className={"xs:w-[282px] lg:w-[401px] xs:px-[20px] lg:px-[35px] py-[17px] rounded-[20px] bg-[#FFEEDD] text-[#4A362A] font-medium  xs:text-[30px] lg:text-[40px] sm:mx-auto md:mx-0 flex justify-center items-center"}>В путешествие<FaLongArrowAltDown className={"relative top-[5px]"} size={30}/></button>
            </div>
